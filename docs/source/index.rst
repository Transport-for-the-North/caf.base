.. CAF.base documentation master file.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive. See the
   `reStructuredText <https://www.sphinx-doc.org/en/master/usage/restructuredtext/index.html>`_
   documentation for details.

Welcome to CAF.base's documentation!
===========================================================

Python package containing a collection of core classes and definitions used in the Common Analytical Framework.

CAF.base source code is available on `GitHub <https://github.com/transport-for-the-north/caf.base>`_.
