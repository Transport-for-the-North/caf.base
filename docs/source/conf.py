...
version = str(caf.base.__version__)
release = version
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/transport-for-the-north/caf.base",
    ...
    "external_links": [
        {
            "name": "Changelog",
            "url": "https://github.com/transport-for-the-north/caf.base/releases",
        },
        {
            "name": "Issues",
            "url": "https://github.com/transport-for-the-north/caf.base/issues",
        },
        {
            "name": "CAF Handbook",
